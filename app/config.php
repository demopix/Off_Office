...
$w_config = [
	//url
	'base_url' => '/Off_Office/public',	//chemin relatif au domaine, menant à la racine de l'appli

   	//information de connexion à la bdd
	'db_host' => 'localhost',						//hôte (ip, domaine) de la bdd
    'db_user' => 'root',							//nom d'utilisateur pour la bdd
    'db_pass' => '',								//mot de passe de la bdd
    'db_name' => 'off_officedb',								//nom de la bdd
	...
	'security_email_property' => 'ursemail',			//nom de la colonne pour l'"email"
