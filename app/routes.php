<?php
 ...
 ["GET|POST", "/backoffice/resetpass/", "Admin#reset_pass", "admin_resetpass"],
	...
	$w_routesAdmin = array(
		...
		["GET|POST", "/employeds/signupUser/", "Admin#insertUsers", "admin_insert_user"],
	    ...
	    ["GET|POST", "/employeds/deleteE/[:id]", "Admin#delete", "admin_delete"],
	    ["GET|POST", "/employeds/deleteU/[:id]", "Users#delete", "users_delete"],
