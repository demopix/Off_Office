...
<?php if ($e):?>
    ...
    <button class="btn btn-warning" type="submit">details</button>
              ...
              <?php if ($w_user['role']== 'ADM'):?> 
              <td><a class="btn btn-danger" href="<?=$this->url("admin_delete", ['id'=> $emp['id']]);?>">supprimer</a></td>
              <?php endif;?> 
            </tr>
        <?php endforeach;?>
          </tbody>
  ...
  <td><a class="btn btn-danger" href="<?=$this->url("users_delete", ['id'=>$c['id']]);?>">supprimer</a></td>
            </tr> <?php endforeach;?>
          </tbody>
